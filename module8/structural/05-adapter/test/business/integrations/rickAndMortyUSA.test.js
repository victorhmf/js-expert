...
describe('RickAndMortyUSA', () => {
  ...
  test('#getCharactersFromXML should return a list of Character Entity', async () => {
    ...
    const expected = [{"gender": "Male", "id": 10, "location": undefined, "name": "Alan Rails", "origin": "unknown", "species": "Human", "status": "Dead", "type": "Superhuman (Ghost trains summoner)"}]
  ...
  test('#getCharactersFromXML should return an empt list if the API returns nothing', async () => {
